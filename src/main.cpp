...
void testAllFunctions() {
    std::cout << "=== 测试矩阵类所有12个功能 ===" << std::endl << std::endl;
    ...
    try {
        ...
        singular3x3(0, 0) = 1; singular3x3(0, 1) = 2; singular3x3(0, 2) = 3;
        singular3x3(1, 0) = 4; singular3x3(1, 1) = 5; singular3x3(1, 2) = 6;
        singular3x3(2, 0) = 7; singular3x3(2, 1) = 8; singular3x3(2, 2) = 9;
