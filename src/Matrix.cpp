...
{
    if (!isSquare())
        throw MatrixException("Adjoint requires square matrix");
...
{
    if (!isSquare())
        throw MatrixException("Inverse requires square matrix");
...
{
    if (!isSquare())
        throw MatrixException("Determinant requires square matrix");
